        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonString != null) {
                try {
                    ...
                    JSONArray pokemons = baseObject.getJSONArray("pokemon");

                    // looping through all Contacts
                    for (int i = 0; i < pokemons.length(); i++) {
                        JSONObject pokemonsJSONObject = pokemons.getJSONObject(i);

                        String name = pokemonsJSONObject.getString("name");
                        String id = pokemonsJSONObject.getString("id");
                        String candy = pokemonsJSONObject.getString("candy");
